...
export const FOR_DRIVERS = {
  ...
  steps: {
    ...
    items: [
      ...
      { t: "The operator decides", d: "The operator sees your checks and your insurance choice together, and says yes or no. If it is a yes, you pay the deposit and first week through Kharo, never to a yard, and book a collection slot that suits you." },
...
export const DRIVER_GUIDE = {
  ...
  steps: [
    ...
    { t: "Hand the car back", d: "At the end you and the operator photograph the car again and note the mileage. The deposit is settled against what was recorded at collection, so nothing is deducted for damage that was already there." },
  ...
  faq: [
    ...
    { q: "What if I miss a payment?", a: "You are told at once and we try again the next day. If you need to spread a payment, a person calls you to arrange it before anything else happens. Keep missing them and Kharo asks Uber and Bolt to pause your account until it is sorted, which is why operators trust the platform with their cars." },
...
export const OPERATOR_GUIDE = {
  ...
  manage: {
    ...
    items: [
      ...
      { t: "Issues", d: "Anything a driver reports about the car reaches you in the console, with photos, the same day. Smaller things too: a warning light, a service due, a tyre. The driver tells Kharo once, we book the garage at the earliest slot that keeps them earning, and you see every job and invoice." },
      { t: "Accidents and claims", d: "A dedicated insurance team handles the claim, the repair and the driver's replacement car." },
      { t: "Tracking", d: "A tracker goes on before handover. From launch your console shows every rented car's location, mileage and handback photographs, so a deposit deduction is a record rather than an argument." },
  ...
  faq: [
    ...
    { q: "What if a driver stops paying?", a: "You are told the same day and a person from Kharo calls the driver to arrange payment. The steps that follow are set out in the operator agreement before you list. We chase first, then ask Uber and Bolt to pause the driver's account until it is settled. That is how rent collection stays close to complete." },
