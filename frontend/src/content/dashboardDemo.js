  ...
  panels: [
    {
      ...
      label: "Payments",
      icon: "Wallet",
      headline: { label: "Next payment, due Friday", value: 203, prefix: "£" },
      kpis: [
        { label: "Weekly rent", value: "£165" },
        { label: "Insurance", value: "£38" },
      ],
      rows: [
        { t: "Rent and insurance", d: "Fri 12 Sep · paid on time", v: "£203", tone: "ok", status: "Paid" },
  ...
  panels: [
    ...
    },
    {
      ...
      rows: [
        ...
        { t: "Elif K. · Skoda Octavia", d: "Vetted · third party, fire and theft selected", v: "Review", tone: "link", status: "Vetted" },
    ...
    },
    {
      ...
      label: "Payouts",
      icon: "Landmark",
      headline: { label: "Next payout, Friday", value: 3465, prefix: "£" },
      kpis: [
        { label: "Collected this week", value: "21 of 21" },
        { label: "Account", value: "··3456" },
      ],
      rows: [
        { t: "Week to 12 Sep", d: "21 rentals collected", v: "£3,465", tone: "ok", status: "Paid" },
        { t: "Week to 5 Sep", d: "21 rentals collected", v: "£3,465", tone: "ok", status: "Paid" },
        { t: "Week to 29 Aug", d: "20 rentals collected · 1 late, recovered", v: "£3,300", tone: "ok", status: "Paid" },
      ],
