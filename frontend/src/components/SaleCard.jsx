      ...
      <div className="p-5">
        <div className="flex items-start justify-between gap-3">
          <div className="min-w-0">
            <h3 className="font-heading font-bold text-[17px] text-[#111] leading-snug truncate">
              {v.make} {v.model}
            </h3>
            <p className="text-[13px] text-[#888] mt-0.5 capitalize">
              {v.year} · {v.fuel} · {typeLabel(v.vehicle_type)}
            </p>
          </div>
          <div className="text-right shrink-0">
            <div className="text-[22px] font-heading font-extrabold text-[#111] leading-none">{formatPrice(v.price)}</div>
            <div className="text-[12px] text-[#888] mt-1">{v.open_to_offers ? "Open to offers" : "Fixed price"}</div>
          </div>
        </div>
