          ...
          <div className="wrap py-4 flex flex-col sm:flex-row sm:items-center gap-4">
            ...
            <div className="flex flex-wrap gap-2.5 w-full sm:w-auto sm:shrink-0">
              <button
                ...
                className="pressable flex-1 sm:flex-none min-w-[9.5rem] h-11 px-5 rounded-md border border-line-strong bg-surface text-ink font-semibold text-[14px] hover:bg-surface-2"
              >
                Reject analytics
              </button>
              <button
