  ...
  return (
    <main className="min-h-page bg-bone wrap-narrow py-section">
      ...
      <RevealGroup className="mt-8">
        <RevealItem>
          <Enter as="h1" className="text-h1 font-heading font-extrabold text-ink">Can't find the right car in {city}?</Enter>
          <Enter as="p" delay={0.08} className="mt-4 text-lead text-ink-2 max-w-[46ch]">Tell us what car you want in {city}. We tell you when it comes up.</Enter>
        </RevealItem>
        <RevealItem className="mt-8 panel rounded-lg p-6 sm:p-8">
